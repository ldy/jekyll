...
![](https://cdn.jsdelivr.net/gh/ldy/asserts@main/2019-03-04-下载Jenkins.png)
...
![](https://cdn.jsdelivr.net/gh/ldy/asserts@main/2019-03-04-Jenkins插件管理.png)
...
![](https://cdn.jsdelivr.net/gh/ldy/asserts@main/2019-03-04-Jenkins系统配置.png)

### 1、配置邮件通知

![](https://cdn.jsdelivr.net/gh/ldy/asserts@main/2019-03-04-Jenkins配置邮件通知.png)

通过勾选Test configuration by sending test e-mail测试配置是否成功。

### 2、配置Publish over SSH

![](https://cdn.jsdelivr.net/gh/ldy/asserts@main/2019-03-04-Jenkins配置SSH.png)

## 任务配置

### 1、新建任务

![](https://cdn.jsdelivr.net/gh/ldy/asserts@main/2019-03-04-Jenkins新建任务.png)

### 2、配置源码

![](https://cdn.jsdelivr.net/gh/ldy/asserts@main/2019-03-04-Jenkins配置源码.png)

### 3、配置构建触发器

Poll SCM不填的话，可以通过Github或者Gitlab的Web hooks服务触发。

![](https://cdn.jsdelivr.net/gh/ldy/asserts@main/2019-03-04-Jenkins构建触发器配置.png)

### 4、配置构建

![](https://cdn.jsdelivr.net/gh/ldy/asserts@main/2019-03-04-Jenkins配置构建.png)
...
![](https://cdn.jsdelivr.net/gh/ldy/asserts@main/2019-03-04-Jenkins配置构建后操作1.png)

Send build artifacts over SSH配置将打包文件上传到SSH服务器后需要执行的命令。

![](https://cdn.jsdelivr.net/gh/ldy/asserts@main/2019-03-04-Jenkins配置构建后操作2.png)
...
![](https://cdn.jsdelivr.net/gh/ldy/asserts@main/2019-03-04-Jenkins验证.png)

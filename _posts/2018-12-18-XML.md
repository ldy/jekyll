...
- 处理指令
  ...
  ![](https://cdn.jsdelivr.net/gh/ldy/asserts@main/2018-12-18-XML处理指令预览效果.png)
...
- DOM[^13]
  ...
  - DOM4J
    ...
    ![XML文档的DOM表示](https://cdn.jsdelivr.net/gh/ldy/asserts@main/2018-12-18-XML文档的DOM表示.gif)
